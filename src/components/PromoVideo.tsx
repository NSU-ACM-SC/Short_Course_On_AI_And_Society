...
export default function PromoVideo() {
  ...
  return (
    <section className="py-20 bg-white brutal-border-thick border-x-0" id="video">
      <div className="max-w-7xl mx-auto px-6">
        <div ref={ref1} className="reveal text-center">
          ...
          <h2 className="text-[clamp(2rem,5vw,3.2rem)] font-bold leading-[1.1] tracking-tight mb-2">
            Watch the <span className="text-acm-blue">Trailer</span>
          </h2>
        </div>
        <div ref={ref2} className="reveal max-w-4xl mx-auto mt-8 brutal-border-thick brutal-shadow-lg bg-black">
          <video
            controls
            preload="metadata"
            poster="/banner.png"
