...
export default function Registration() {
  ...
  const regLink = registrationData.registrationLink;
        ...
        <div ref={ref} className="reveal text-center">
          ...
          <div>
            ...
            {regLink ? (
              ...
              >
                {registrationData.buttonLabel}
              </a>
            ) : (
              <>
                <button
                  onClick={() => alert(registrationData.alertMessage)}
                ...
                <div className="inline-block bg-white/15 border-2 border-dashed border-white/40 px-6 py-3 font-mono text-sm text-white/70 mt-4 italic">
                  {registrationData.pendingNotice}
                </div>
              </>
            )}
          </div>
