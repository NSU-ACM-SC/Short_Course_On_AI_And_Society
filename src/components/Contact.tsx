...
export default function Contact() {
  ...
  return (
    <section className="py-20 bg-white brutal-border-thick border-x-0" id="contact">
      <div className="max-w-7xl mx-auto px-6">
        <div ref={titleRef} className="reveal">
          ...
          <h2 className="text-[clamp(2rem,5vw,3.2rem)] font-bold leading-[1.1] tracking-tight mb-8">
            Get In <span className="text-acm-blue">Touch</span>
          </h2>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Email */}
          <div ref={ref1} className="reveal bg-offwhite brutal-border-thick brutal-shadow p-8">
          ...
          {/* Phone */}
          <div ref={ref2} className="reveal bg-offwhite brutal-border-thick brutal-shadow p-8">
            <h4 className="flex items-center gap-2 font-mono text-sm font-bold uppercase tracking-widest text-acm-blue mb-4">
              <PhoneIcon className="w-4 h-4" />
              Phone
            </h4>
            {chapterPhones.map((phone) => (
          ...
          {/* Address */}
          <div ref={ref3} className="reveal bg-offwhite brutal-border-thick brutal-shadow p-8">
            <h4 className="flex items-center gap-2 font-mono text-sm font-bold uppercase tracking-widest text-acm-blue mb-4">
            ...
            >
              ...
              <br />
              {chapterAddress.line2}
              <br />
              {chapterAddress.line3}
            </a>
          </div>
        </div>
      </div>
